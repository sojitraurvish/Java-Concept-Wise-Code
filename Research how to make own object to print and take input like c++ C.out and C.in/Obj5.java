...
{
    //output methods
    public <T> Cout <C,S,B,Sh,I,L,F,D,V> c(T v)//to print only char in small latter
    {
        System.out.printf("%c",v);
        return this;
    }

    public Cout <C,S,B,Sh,I,L,F,D,V> cc(C v)//to print only char in Capital latter
    {
        System.out.printf("%C",v);
        return this;
    }

    public Cout <C,S,B,Sh,I,L,F,D,V> s(S v)//to print only small leater string
    {
        System.out.printf("%s",v);
        return this;
    }

     public Cout <C,S,B,Sh,I,L,F,D,V> cs(S v)//to print only capitel leater string
    {
        System.out.printf("%S",v);
        return this;
    }

    public Cout <C,S,B,Sh,I,L,F,D,V> b(B v)//to print only byte 
    {
        System.out.printf("%d",v);
        return this;
    }

    public Cout <C,S,B,Sh,I,L,F,D,V> sh(Sh v)//to print only short
    {
        System.out.printf("%d",v);
        return this;
    }

    public Cout <C,S,B,Sh,I,L,F,D,V> i(I v)//to print only int
    {
        System.out.printf("%d",v);
        return this;
    }

    public Cout <C,S,B,Sh,I,L,F,D,V> l(L v)//to print only long
    {
        System.out.printf("%d",v);
        return this;
    }

    public Cout <C,S,B,Sh,I,L,F,D,V> f(F v)//to print only float
    {
        System.out.printf("%f",v);
        return this;
    }

    public Cout <C,S,B,Sh,I,L,F,D,V> d(D v)//to print only double
    {
        System.out.printf("%f",v);
        return this;
    }

    public Cout <C,S,B,Sh,I,L,F,D,V> n()//to taking new line
    {
        System.out.println();
        return this;
    }
